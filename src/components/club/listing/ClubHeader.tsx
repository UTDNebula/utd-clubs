  ...
  return (
    <BaseCard className="relative min-h-64 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-wrap min-h-64 h-full w-full items-center p-4 md:p-20 gap-4">
        <h1
          className={`font-display font-bold text-slate-100 dark:text-slate-900 text-shadow-[0_0_16px_rgb(0_0_0_/_0.4)] dark:text-shadow-[0_0_16px_rgb(255_255_255_/_0.4)] ${
