...
const CountdownTimer = ({ startTime }: { startTime: Date }) => {
  ...
  return (
    <>
      <p className="text-sm font-semibold text-slate-600">Starts in</p>
      <div className="mt-5 flex justify-start"></div>
      <div className="flex text-3xl font-medium text-slate-600">
      ...
      <div className="mt-5 flex justify-start text-sm font-medium text-slate-400">
