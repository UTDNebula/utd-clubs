...
const UserList = ({ members, club }: MemberListProps) => {
  ...
  const memberListDeletionState = useUserListDeletionState(
    rows,
    rowSelectionModel,
  );
  ...
  return (
    <div className="flex flex-col gap-8 w-full max-w-6xl">
      <UserListContext.Provider value={MemberListContextValues}>
        <DataGrid
          rows={rows}
