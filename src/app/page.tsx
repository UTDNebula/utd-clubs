          ...
          <div className="relative h-[120vh] w-screen">
            <section className="absolute inset-0 h-[120vh] w-screen">
              ...
              <Image
                  ...
                  className="bg-no-repeat object-cover absolute bottom-[30%] right-[10%] w-[clamp(200px,20vw,300px)]"
              />
              <Image
                  src={starDoodle}
                  //width={170}
                  ...
                  className="bg-no-repeat object-cover absolute top-[5%] right-[15%] w-[clamp(170px,20vw,200px)] animate-spin [animation-duration:77s] [animation-direction:reverse]"
              />
              <Image
                  src={starDoodle}
                  //width={140}
                  ...
                  className="bg-no-repeat object-cover absolute bottom-[35%] left-[7%] w-[clamp(70px,20vw,150px)] animate-spin [animation-duration:60s]"
              />
            </section>
